...
- For GPU support with CUDA, use the image:

```bash
docker pull numpower/numpower:ubuntu-php82-cuda
```
...
```bash
docker run --gpus all -it --rm -v /path/to/your/code:/app numpower/numpower:ubuntu-php82-cuda php /app/your-script.php
```
